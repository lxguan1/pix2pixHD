...
for i in {1..700}
do
    python3 train.py --name idealized_E4 --label_nc 0 --continue_train --no_instance  --dataroot ./datasets/E4 --no_vgg_loss  --resize_or_crop crop  --no_flip --start_epoch  $i --gan_loss_numpy all_gan_loss_4.npy --disc_loss_numpy all_disc_loss_4.npy
