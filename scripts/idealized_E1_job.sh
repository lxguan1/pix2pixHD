...
#SBATCH --job-name=idealized_E1_job
...
for i in {1..700}
do
#    python3 train.py --name idealized_E1 --label_nc 0 --continue_train --no_instance  --dataroot ./datasets/E1 --no_vgg_loss  --resize_or_crop crop --start_epoch  $i --gan_loss_numpy all_gan_loss.npy --disc_loss_numpy all_disc_loss.npy
    python3 test.py --name idealized_E1 --resize_or_crop crop --no_instance --which_epoch $i --label_nc 0 --how_many 300 --dataroot ./datasets/E1 --numpy_file_rmse E1_test_rmse.npy --numpy_file E1_test.npy
    python3 test.py --name idealized_E1 --resize_or_crop crop --no_instance --which_epoch $i --label_nc 0 --how_many 240 --dataroot ./datasets/E1 --phase val --numpy_file_rmse E1_val_rmse.npy --numpy_file E1_val.npy

done
#python3 test.py --name idealized_E1 --resize_or_crop crop --no_instance --which_epoch 700 --label_nc 0 --how_many 100 --dataroot ./datasets/E1 > out.txt
