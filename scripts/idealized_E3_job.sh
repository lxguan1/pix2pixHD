...
for i in {1..700}
do
    python3 train.py --name idealized_E3 --label_nc 0 --continue_train --no_instance  --dataroot ./datasets/E3 --no_vgg_loss  --resize_or_crop crop  --no_flip --start_epoch  $i --gan_loss_numpy all_gan_loss_3.npy --disc_loss_numpy all_disc_loss_3.npy
