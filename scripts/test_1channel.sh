...
#SBATCH --job-name=p2pHD1channeltest
...
python3 train.py --name test1channel --label_nc 0 --no_instance --input_nc 1 --output_nc 1  --dataroot ./datasets/Idealized --resize_or_crop crop # --no_flip
